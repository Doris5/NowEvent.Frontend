            ...
            <Container>
                <Row className="items-center">
                    <Col cs={12} md={6} xl={7}>
                        ...
                        <p>Welcome to NowEvent! We're glad that you're here. We know that plannig events is not an easy task, and requires a lot of free time.
                            NowEvent was created to help people create their events in a fast and easy way.
                            All you need to do is sign up and choose all the details, and don't forget to have fun! :)</p>
